...
const WhatBean=()=> {
    ...
    return (
        <div className="whatbean__whatbean section__margin" id="wbean">
            <div className="whatbean__whatbean-feature">
                <Feature title="WhatTheBean-BeanTector"/>
